...
ActiveRecord::Schema[8.1].define(version: 2026_09_01_070953) do
  ...
  create_table "drinks", force: :cascade do |t|
    ...
    t.index "user_id, lower((name)::text)", name: "index_drinks_on_user_id_and_lower_name", unique: true
  ...
  create_table "fun_facts", force: :cascade do |t|
    ...
    t.string "drink_name"
    t.datetime "updated_at", null: false
    t.index ["drink_name"], name: "index_fun_facts_on_drink_name"
  end

  create_table "ingredients", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "flavor_profiles", default: [], null: false, array: true
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "seeded_account", default: false, null: false
    t.datetime "updated_at", null: false
    t.string "username"
